...
print("=" * 60)
print("HIWONDER SERVO BATCH RECORDING (BOARD CONTROLLER)")
print("=" * 60)
...
print()
print("Using Hiwonder Board Controller:")
print("  ✓ More reliable communication")
print("  ✓ Synchronized control")
...
print("\n" + "=" * 60)
print("BATCH RECORDING COMPLETE (BOARD CONTROLLER)")
print("=" * 60)
...
print("\n✓ All recordings completed successfully with board controller!")
